...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://api.telegram.org/bot5075852532:AAFoFyq3YBBwaa9ZpsFHUFTf8C1aDgNi5UA/getupdates');
...
echo date('m/d/Y H:i:s', 1658559166);
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <div class="fname col-sm-12 col-lg-7"><?php echo $message->channel_post->text ?></div>
